...
\item Scott Field (University of Massachusestts Dartmouth)
...
\begin{itemize}
\item Executive committee (\emph{exec@black-holes.org}): Duez,
  Foucart, Kidder, Lovelace, Pfeiffer, Scheel, Stein, Teukolsky,
  Zimmerman
